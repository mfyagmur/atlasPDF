...
from app.tools.pdf_to_word.service import pdf_to_word
...
@log_tool_call("pdf_to_word")
async def pdf_to_word_endpoint(request: Request, file: UploadFile) -> dict[str, str | None]:
    ...
    try:
        ...
        output_path = settings.output_dir / f"{output_id}.docx"

        try:
            result = pdf_to_word(saved_path, output_path)
